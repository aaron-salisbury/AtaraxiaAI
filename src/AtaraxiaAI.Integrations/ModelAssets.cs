...
namespace AtaraxiaAI.Integrations
{
    internal static class ModelAssets
    {
        ...
        internal static byte[] YoloConfiguration => File.ReadAllBytes("./Detection/Vision/YOLO/yolov3.cfg");
        internal static byte[] YoloWeights => File.ReadAllBytes("./Detection/Vision/YOLO/yolov3.weights");
